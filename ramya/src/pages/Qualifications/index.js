...
export default function Qualifications() {
  return (
    <List sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper', p: 3}}>
      ...
      <ListItem alignItems="flex-start">
        <ListItemAvatar>
          <Avatar alt="Alphores Junior College" src="https://www.w3schools.com/howto/img_avatar.png" />
        </ListItemAvatar>
        <ListItemText
      ...
      <ListItem alignItems="flex-start">
        <ListItemAvatar>
          <Avatar alt="Siddhartha English Medium High School" src="https://55knots.com.au/wp-content/uploads/2021/01/Zanj-Avatar-scaled.jpg" />
        </ListItemAvatar>
        <ListItemText
          primary="Siddhartha English Medium High School"
          secondary={
            <React.Fragment>
              <Typography
                sx={{ display: 'inline' }}
